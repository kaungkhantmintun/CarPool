...
$result = mysqli_query($conn, "select t.*,v.*,vc.* from tbl_trips t,tbl_vehicle v,tbl_vehicle_category vc where trip_vehicle_id=v.id and vehicle_cat_id=car_id and trip_avilable_seat>0 and trip_status!='CANCEL' and depature_date>=Now() and trip_user_id='$userid' order by t.trip_id DESC");
if ($result) {
    $ride = array();
    ...
    $response['message'] = "Ride not Avaliable";
}
