...
<html lang="en">
    ...
    <body>
    <input type="hidden" value="upcoming" id="page_name">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h1 class="page-header">Upcoming Rides</h1>
                                    ...
                                    <tbody>
                                        ...
                                        while ($rowtrip = mysqli_fetch_array($gettrip)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><center><a href="RideDetail.php?id=<?php echo $id; ?>"><i class="fa fa-edit"></i></a></center></td>
                                        </tr>
                                        <?php
                                        $no++;
                                    }
